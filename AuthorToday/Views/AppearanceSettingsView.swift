...
struct AppearanceSettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section {
                Text("Бесплатно: классические темы (Мох, Author.Today, Океан, Вино, Графит, Песок). Futuristic, фото-темы и свой цвет — в Pro. Тема «Author.Today» повторяет цвета сайта (#4582af). Тема задаёт живой фон и акцент; фон читалки настраивается отдельно.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
            }
        }
